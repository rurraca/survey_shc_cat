...
source('scripts/subsample/calc_subsample.R')
...
# save
subsample %>%
  write_csv(sprintf('data/proc/subsample/subsample_tol-%.2f.csv', tol_pct * 100))
sub_stats %>%
  write_csv(sprintf('data/proc/subsample/subsample_stats_tol-%.2f.csv', tol_pct * 100))
