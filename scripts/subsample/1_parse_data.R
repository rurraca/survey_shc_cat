...
sample %>% write_csv("data/proc/subsample/sample.csv")
sample_stats %>% write_csv("data/proc/subsample/sample_stats.csv")
...
pop_stats %>% write_csv("data/proc/subsample/pop_stats.csv")
